<script lang="ts">
	import '../app.css';
	import { Icon, Input, YesNoPopup, toast, Button } from '$lib';
...
<Button type={ButtonType.OutlinePrimary} clickLogic={(e) => console.log(e.detail)} />

<Input type={InputTypes.Number}></Input>